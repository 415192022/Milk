 ...
 *  我的收藏
 */
public class CartFooterListAdapter extends RecyclerView.Adapter<CartFooterListAdapter.GoodsHolder> implements View.OnClickListener{

    private ArrayList<GoodsListModel> mList;
    private Activity mContext;

    public CartFooterListAdapter(Activity context) {
