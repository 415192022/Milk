package com.yundong.milk.widget;
...
public class ProgressWheel extends View {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		int width;
		int height;
		if (widthMode == MeasureSpec.EXACTLY) { // Measure Width
			width = widthSize; // Must be this size
		} else if (widthMode == MeasureSpec.AT_MOST) {
			width = Math.min(viewWidth, widthSize); // Can't be bigger than...
		} else {
			width = viewWidth; // Be whatever you want
		}
		if (heightMode == MeasureSpec.EXACTLY || widthMode == MeasureSpec.EXACTLY) { // Measure Height
			height = heightSize; // Must be this size
		} else if (heightMode == MeasureSpec.AT_MOST) {
			height = Math.min(viewHeight, heightSize); // Can't be bigger than...
		} else {
			height = viewHeight; // Be whatever you want
		}
