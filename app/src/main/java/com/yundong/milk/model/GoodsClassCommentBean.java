...
public class GoodsClassCommentBean {
    private String code;
    private String msg;
    private GoodsClassCommentDataO data;
    ...
    public void setData(GoodsClassCommentDataO data) {
        this.data = data;
    }
    ...
    public GoodsClassCommentDataO getData() {
        return data;
    }

    public class GoodsClassCommentDataO{
        ...
        private String from;
        private String to;
        private ArrayList<GoodsClassCommentDataA> data;
        ...
        public void setData(ArrayList<GoodsClassCommentDataA> data) {
            this.data = data;
        }
        ...
        public ArrayList<GoodsClassCommentDataA> getData() {
            return data;
        }

        public class GoodsClassCommentDataA{
